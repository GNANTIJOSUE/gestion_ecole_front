...
const SecretaryDashboard = () => {
  ...
  useEffect(() => {
    ...
    setLoading(true);
    Promise.all([
      axios.get(`https://schoolapp.sp-p6.com/api/students?school_year=${schoolYear}`, { headers }), // inscrits
      axios.get(`https://schoolapp.sp-p6.com/api/students`, { headers }), // total
      axios.get(`https://schoolapp.sp-p6.com/api/classes?school_year=${schoolYear}`, { headers }),
      axios.get(`https://schoolapp.sp-p6.com/api/payments?school_year=${schoolYear}`, { headers }),
      axios.get(`https://schoolapp.sp-p6.com/api/events/all?school_year=${schoolYear}`, { headers }),
