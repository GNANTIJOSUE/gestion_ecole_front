...
const GestionEleves = () => {
    ...
    const fetchStudents = async (currentFilters = filters) => {
        ...
        try {
            ...
            const response = await axios.get('https://schoolapp.sp-p6.com/api/students', { headers, params });
    ...
    useEffect(() => {
        ...
        const fetchInitialData = async () => {
            ...
            try {
                ...
                const classesPromise = axios.get('https://schoolapp.sp-p6.com/api/classes', { headers });
                const studentsPromise = axios.get('https://schoolapp.sp-p6.com/api/students', { headers, params: { school_year: schoolYear } });
